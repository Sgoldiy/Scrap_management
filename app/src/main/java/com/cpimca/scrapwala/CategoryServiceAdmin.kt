...
@Composable
fun CategoryServiceAdmin(
    requests: List<CategoryServiceRequest>,
    isFetching: Boolean,
    onConfirm: (CategoryServiceRequest) -> Unit,
...
@Composable
fun CategoryServiceRequestCard(
    navController: NavController,
    request: CategoryServiceRequest,
    onConfirm: (CategoryServiceRequest) -> Unit,
) {
    Card(
        modifier = Modifier
...
@Composable
fun UserRequestCategory(
    viewModel: CategoryServiceViewModel = androidx.lifecycle.viewmodel.compose.viewModel(),
    navController: NavController,
) {

    // Define the onConfirm function
    val onConfirm: (CategoryServiceRequest) -> Unit = { request ->
        // Perform Firestore operations to transfer data from the original collection to the new collection
        // For example:
        val db = Firebase.firestore
        val confirmRequestsRef = db.collection("confirm_category_pickup")

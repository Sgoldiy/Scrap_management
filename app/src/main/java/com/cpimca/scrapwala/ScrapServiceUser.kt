...
@Composable
fun ScrapServiceUser(navController: NavController) {
    val viewModel: ScrapServiceViewModel = viewModel()

    var locationAddressForCleaningService by remember { mutableStateOf(TextFieldValue("")) }
    var isFetching by remember { mutableStateOf(false) }
    val context = LocalContext.current
    var IteminKG by remember { mutableStateOf("") }

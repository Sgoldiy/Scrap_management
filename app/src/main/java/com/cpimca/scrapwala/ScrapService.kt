...
@Composable
fun ScrapService(navController: NavController) {
    Box(
                ...
                Card(
                    ...
                    Column(
                        modifier = Modifier
                            ...
                            .clickable {
                                navController.navigate(Route.ScrapServiceUser)
                            },
                ...
                Card(
                    ...
                    Column(
                        modifier = Modifier
                            ...
                            .background(Color.White, shape = RoundedCornerShape(8.dp))
                            .clickable {
                                navController.navigate(Route.ScrapServiceConfirmUser)
                            },
                        horizontalAlignment = Alignment.CenterHorizontally,
                        verticalArrangement = Arrangement.Center,
            ...
            Card(
                ...
                Column(
                    modifier = Modifier
                        ...
                        .background(Color.White, shape = RoundedCornerShape(8.dp))
                        .clickable {
                            navController.navigate(Route.MonthlyScrapServiceComplain)
                        },
                    horizontalAlignment = Alignment.CenterHorizontally,
                    verticalArrangement = Arrangement.Center,

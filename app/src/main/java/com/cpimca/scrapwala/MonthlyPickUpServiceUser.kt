...
@Composable
fun MonthlyPickUpServiceUser(navController: NavController) {
    val viewModel: MonthlyPickUpServiceViewModel = viewModel()
    ...
    Column(
        ...
        Box {
            OutlinedTextField(
                value = "Duration of Pickup: $selectedNumber",
                onValueChange = {},
        ...
        Button(
            onClick = {
                ...
                navController.navigate(Route.MonthlyPickUpService) {
                    popUpTo(Route.MonthlyPickUpServiceUser) {
                        inclusive = true
                    }
                }
            },
